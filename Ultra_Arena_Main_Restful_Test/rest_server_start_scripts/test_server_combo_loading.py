...
def main():
    ...
    try:
        ...
        if "combo_test_8_strategies_4f" in combos:
            print(f"✅ combo_test_8_strategies_4f found in available combos")
        else:
            print(f"❌ combo_test_8_strategies_4f NOT found in available combos")
